...
push 2
push 3
pallvagrant@vagrant-ubuntu-trusty-64:~/monty$ gcc -Wall -Werror -Wextra -pedantic *.c -o monty -g
...
| stack_func2.c | It contains other functions for print char such as: ***_pchar, _nop***
 ...
 ## Requirements project-  Allowed editors: vi, vim, emacs
...
* **Adeyemi Afeez** - [Feezat01](https://github.com/Feezat01)
